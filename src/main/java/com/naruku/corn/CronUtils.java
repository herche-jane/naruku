...
//      Date startTime = taskScheduleModel.getScheduleStartTime();
	...
	public static void main(String[] args) {
		...
		// 每月的1号2号 10时12分0秒执行
		Integer[] dayOfMonths = new Integer[2];
		dayOfMonths[0] = 1;
		dayOfMonths[1] = 2;
		...
		// 每周的周1周2周3 10时12分0秒执行
		TaskScheduleModel weekModel = new TaskScheduleModel();
		Integer[] dayOfWeeks = new Integer[3];
		dayOfWeeks[0] = 1;
		dayOfWeeks[1] = 2;
		dayOfWeeks[2] = 3;
		weekModel.setJobType(3)
				.setSecond(0)
				.setDayOfWeeks(dayOfWeeks)
				.setHour(10)
				.setMinute(12);
		cropExp = createCronExpression(weekModel);
		System.out.println(cropExp + ":" + createDescription(weekModel));
		
		// 每天10时12分0秒执行
		TaskScheduleModel dayModel = new TaskScheduleModel();
		Integer[] dayOfMonths1 = new Integer[2];
		dayOfMonths1[0] = 1;
		dayOfMonths1[1] = 2;
		dayModel.setJobType(1)
				.setSecond(0)
				.setDayOfMonths(dayOfMonths1)
				.setHour(10)
				.setMinute(12);
		cropExp = createCronExpression(dayModel);
		System.out.println(cropExp + ":" + createDescription(dayModel));
	}
