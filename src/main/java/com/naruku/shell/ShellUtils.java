...
import com.naruku.shell.jna.Platform;
...
public class ShellUtils {
    ...
    private ShellUtils(Logger logger) {
        this.logger = logger;
    ...
    private static Charset getCharset() {
        if (Platform.isWindows()) {
            try {
                ...
                logger.debug("shell exec system code={}", print);
                ...
                logger.error("get charset error ", e);
            }
        }
        return StandardCharsets.UTF_8;
    }
